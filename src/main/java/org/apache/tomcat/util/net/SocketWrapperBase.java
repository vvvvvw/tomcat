...
public abstract class SocketWrapperBase<E> {
     ...
     */
    protected final Semaphore readPending; //猜测这个应该是用来 限流的，我也没有具体看使用的地方
     ...
     * with the wrapper.
     */
    protected Object currentProcessor = null; //用来处理请求的Processor，举例： Http11Processor
    ...
    //SocketWrapper 的 processSocket 方法会创建 SocketProcessor 任务类，并通过 Tomcat 线程池来处理
