        ...
        try {
            ...
            while (!stopCalled) {
                ...
                try {
                    ...
                    endpoint.countUpOrAwaitConnection(); //获取连接
                    ...
                    try {
                        ...
                        // socket
                        //调用ServerSocketChannel 的 accept() 方法接受新的连接
                    ...
                    if (!stopCalled && !endpoint.isPaused()) {
                        ...
                        //调用ServerSocketChannel 的 setSocketOptions() 方法 （1.设置socket属性;2.把 SocketChannel 对象封装在一个 PollerEvent 对象中，并将 PollerEvent 对象压入 Poller 的 Queue 里）
